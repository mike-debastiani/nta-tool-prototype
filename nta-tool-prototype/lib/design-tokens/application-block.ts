/**
 * Surfaces for Antrags-Inhaltsblöcke (Review, Portal-Adjustment, R4, Empfehlung, R1-Formular).
 * HF «General» border: semantic `border-border` (light theme → `--hf-border` / `--hf-stone-250`).
 */
