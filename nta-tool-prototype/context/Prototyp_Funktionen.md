...
- **Home-Inbox vs. Aufgaben:** Home zeigt breite RLS-Liste ohne Beratungsphase (keine vollständigen Anträge in «Beratung & Empfehlung» / «Empfehlung verfasst»); Meine Aufgaben nur persönliche Bearbeitungsfälle inkl. offener Beratungen — siehe `Dashboard_Core_Layout_Kontext.md` § Workspace Home
